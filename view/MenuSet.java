...
public class MenuSet extends JFrame {
	...
	private JLabel searchLabel = new JLabel("내용검색");
	private JButton btn_a = new JButton("조회");
	private JButton btn_b = new JButton("추가");
	private JButton btn_c = new JButton("삭제");
	private JButton btn_d = new JButton("변경");
